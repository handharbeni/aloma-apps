...
public class PrivacyAdapter extends RecyclerView.Adapter<PrivacyAdapter.ViewHolder> {
    ...
    public PrivacyAdapter(ArrayList<AppInfo> data, Context applicationContext){
        this.data = data;
        this.mContext = applicationContext;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_privacy_policy,parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            txtTitle = itemView.findViewById(R.id.titlePrivacyPolicy);
            txtContent = itemView.findViewById(R.id.contentPrivacyPolicy);
        }
    }
}
